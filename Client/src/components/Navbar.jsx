  ...
  return (
    <div>
      <Menu as="div" className="inline-block text-left">
        <div className="flex">
          <Menu.Button className="inline-flex gap-2 w-full rounded-md bg-white md:px-4 py-2 text-sm font-medium  text-slate-700 hover:bg-opacity-20">
            ...
            <img
              src={user?.profileUrl}
              alt="user Profile"
              className="w-10 h-10 rounde-full object-cover"
            />
            <BiChevronDown
        ...
        >
          <Menu.Items className="absolute z-50 right-2 mt-2 w-56 origin-top-right divide-y dividfe-gray-100 rounded bg-white shadow-lg focus:outline-none">
            <div className="p-1">
              <Menu.Item>
                {({ active }) => (
                  <Link
      ...
      <div className="relative bg-[#f7fdfd] z-50">
        <nav className="container mx-auto flex items-center justify-between p-5">
          ...
          <ul className="hidden lg:flex gap-10 text-base">
            ...
            <li>
              <Link to={ user?.accountType === "seeker" ? "/application" :"/upload-job"}>
          ...
          <button className="block lg:hidden text text-slate-900 " onClick={()=>setIsOpen((prev => !prev))}>
